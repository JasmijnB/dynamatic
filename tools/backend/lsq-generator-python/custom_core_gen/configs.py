...
class QueueConfig:
    ...
    queue_addr_width: int = 2  # queue address width
    ...
    def __init__(self, config: dict):
        self.queue_type = config["QueueType"]
        ...
        self.queue_addr_width = math.ceil(math.log2(self.num_entries))
        ...
        assert(self.queue_type in ["load", "store"]), "QueueType must be either 'load' or 'store'"
        ...
        assert(self.queue_addr_width > 0), "QueueAddrWidth must be greater than 0"
