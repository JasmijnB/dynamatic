...
struct LSQGenerationInfo {
  ...
  // ldOrder = [
  //    [1, 2], (in group 0: there is a store before ld0 and two stores before
  //    ld1) [1]     (in group 1: there is a store before ld2)
  // ]
  ...
  // padding included.
  // Following the example above, we have the following configuration for
  // stPortIdx stPortIdx = [
